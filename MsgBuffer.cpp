...
void CMsgBuffer::SetCmdOpt1( BYTE nCmdOpt1 )
{
	// set the command option 1
	m_nCmdOpt1 = nCmdOpt1;
}

void CMsgBuffer::SetCmdOpt2( BYTE nCmdOpt2 )
{
...
BYTE CMsgBuffer::GetCmdOpt1( void )
{
	// return the command option 1
	return( m_nCmdOpt1 );
}

BYTE CMsgBuffer::GetCmdOpt2( void )
{
...
void CMsgBuffer::CopyMessage( CMsgBuffer* pSrc )
{
	...
	m_nCmdOpt1	= pSrc->m_nCmdOpt1;
	m_nCmdOpt2	= pSrc->m_nCmdOpt2;
